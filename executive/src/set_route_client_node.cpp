...
int main(int argc, char **argv) {
  ...
  // setting straight_point_distance
  if (ros::param::has("/global_planner/simple_planner/straight_point_distance"))
  {
    ros::param::set("/global_planner/simple_planner/straight_point_distance", route_file["st_points_distance"].as<double>());
  } 
  else {
    std::cout <<"[set_route_client]: /global_planner/simple_planner/straight_point_distance not available"<<std::endl;
  }

  // setting corner_density
  if (ros::param::has("/global_planner/simple_planner/corner_density"))
  {
    ros::param::set("/global_planner/simple_planner/corner_density", route_file["corner_density"].as<double>());
  } 
  else {
    std::cout <<"[set_route_client]: /global_planner/simple_planner/corner_density not available"<<std::endl;
  }
