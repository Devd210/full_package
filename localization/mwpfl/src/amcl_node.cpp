        ...
        first_reconfigure_call_(true)
{
  ...
  private_nh_.param("odom_noise_rot_rot", alpha1_, 0.2);
  private_nh_.param("odom_noise_rot_trans", alpha2_, 0.2);
  private_nh_.param("odom_noise_trans_trans", alpha3_, 0.2);
  private_nh_.param("odom_noise_trans_rot", alpha4_, 0.2);
  ...
  private_nh_.param("odom_model_type", tmp_model_type, std::string("diff-corrected"));
  ...
  private_nh_.param("update_min_distance", d_thresh_, 0.2);
  private_nh_.param("update_min_angle", a_thresh_, M_PI/6.0);
  ...
  pose_pub_ = nh_.advertise<geometry_msgs::PoseWithCovarianceStamped>("estimated_pose", 2, true);
...
void AmclNode::savePoseToServer()
{
  ...
  private_nh_.setParam("initial_pose_yaw", yaw);
