...
# This small script subscribes to the FeedbackMsg message of mw_teb
...
import rospy, math
from mw_teb.msg import FeedbackMsg, TrajectoryMsg, TrajectoryPointMsg
...
def velocity_plotter():
  ...
  rospy.loginfo("Make sure to enable rosparam 'publish_feedback' in the mw_teb.")
