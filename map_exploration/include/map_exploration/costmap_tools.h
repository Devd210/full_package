#ifndef MAP_EXPLORATION__COSTMAP_TOOLS_H_
#define MAP_EXPLORATION__COSTMAP_TOOLS_H_
...
std::vector<unsigned int> nhood4(unsigned int idx,
  ...
  if (idx > size_x_ * size_y_ - 1) {
    ROS_WARN("[Explore Server]: Evaluating nhood for offmap point");
    return out;
  }
...
#endif  // MAP_EXPLORATION__COSTMAP_TOOLS_H_
