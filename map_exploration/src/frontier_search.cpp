...
#include <map_exploration/costmap_tools.h>
...
std::vector<Frontier> FrontierSearch::searchFrom(geometry_msgs::Point position) {
  ...
  if (!costmap_->worldToMap(position.x, position.y, mx, my)) {
    ROS_ERROR("[Explore Server]: Robot out of costmap bounds, cannot search for frontiers");
  ...
  if (nearestCell(clear, pos, FREE_SPACE, *costmap_)) {
    ...
    bfs.push(pos);
    ROS_WARN("[Explore Server]: Could not find nearby clear cell to start search");
  }
